...
(function (global) {
    ...
    Switcheroo.prototype.createSwitcherooUser =
        function (user, wrapper) {
            ...
            /*
             * El nombre utiliza el mismo color
    ...
    Switcheroo.prototype.createTooltip =
        function (tooltip) {
            ...
            /*
             * IMPORTANTE:
             * El color se aplica al texto,
             * no al usuario actualmente conectado.
             */
